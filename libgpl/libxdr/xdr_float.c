/* $Id: xdr_float.c,v 1.2 2004/12/30 22:16:40 alex Exp alex $ */
...
#ifndef IEEEFP
#    define IEEEFP
			/* VAX C has problem with line continuation in "#if". */
#    if !defined(__m68k__) && !defined(__sparc__)
#    if !defined(sparc) && !defined(i386)
#    if !defined(__i386__) && !defined(__mips__)
#    if !defined(__ns32k__) && !defined(__alpha__)
#    if !defined(__arm32__) && !defined(__powerpc__)
#    if !defined(__m88k__) && !defined(__hppa__)
#        undef  IEEEFP
#    endif
#    endif
#    endif
...
#    endif
#    endif
#    if defined(IEEEFP) && defined(HAVE_MACHINE_ENDIAN_H)
#        include <machine/endian.h>
#    endif
#endif

/*******************************************************************************
    Byte-order determination added by Alex Measday to OpenBSD code.
*******************************************************************************/
...
#ifdef NDS
#    define  fp  value			/* NDS library has a typedef for fp. */
#endif
